...
export default function DestinationScreen(props) {
	...
	<View className="bg-white flex-1">
		...
		<SafeAreaView className="flex-row justify-between items-center w-full absolute">
			...
			<TouchableOpacity onPress={()=> toggleFavourite(!isFavourite)} className="p-2 rounded-full mr-4" style={{backgroundColor: "rgba(225, 225, 225, 0.4)"}}>
	...
	{/* title & Descriptio & booking Button */}
	<View 
